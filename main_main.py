...
def last_window():
    ...
    if calib_flage:
        ...
        last_window.geometry("1500x1000")
        # popup_window()
        ...
        def capture():
            global dia,Imagelist,final_img,serial
            if serial:
        ...
        input_label = Label(last_window, text="Serial no :",font=("times new roman",10, "bold"),fg="white", height=1, width=10)
        input_label.place(x=1000, y=70)
        input_entry = Entry(last_window)
        input_entry.place(x=950,y=100)
        ...
        open_another_button.place(x=1100,y=100)
        ...
        open_another_button.place(x=200,y=650)
        ...
        open_another_button4.place(x=600,y=650)
        ...
        open_another_button5.place(x=1100,y=650)
